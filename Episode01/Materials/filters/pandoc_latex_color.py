...
def get_correct_color(color):
    ...
    # DHH: restricting colors to X11 colors would mean that
    # any custom colors defined in header-includes: won't
    # work. So, just pass through the color to LaTeX without
    # validating it.
